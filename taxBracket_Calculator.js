        ...
        if (status == 0) { 
          ...
          *******************************************************************************/
                ...
                if (income <= 9525){
                    ...
                    tax= 9525 * 0.10 + (38700 - 9525) * 0.12 +
                    (82500 - 38700) * 0.22 + (15700 - 82500) * 0.24 +
                    (200000 - 157500) * 0.32 + (income - 200000) * 0.35;
                    taxRate = 35;
                }//end of else if
                else {
...
function clearButton () {
             ...
             //INSERT YOUR CODE BELOW
             document .getElementById("fillingStatus").selectedIndex = 1;
             
             document .getElementById("fillingStatus").selectedIndex = 2;
             
             document .getElementById("fillingStatus").selectedIndex = 3;
